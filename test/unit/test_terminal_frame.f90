program test_terminal_frame
  ...
  if (index(rendered, "KEYS") == 0) error stop "frame should render footer keybar"
  if (index(rendered, "1000ms | samples") == 0) error stop "frame should render compact footer timing"
