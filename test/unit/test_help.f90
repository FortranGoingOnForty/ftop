...
contains
  ...
  subroutine test_help_overlay_renders()
    ...
    call require(index(text, "Enter/Down: tree active") > 0, "help overlay should render process down binding")
    call require(index(text, "Esc: leave zoom") > 0, "help overlay should render zoom escape binding")
    call require(index(text, "Esc: return arrows") > 0, "help overlay should render process escape binding")
